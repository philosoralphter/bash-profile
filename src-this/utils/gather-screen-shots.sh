...
function gather-screenshots () {
    ...
    find $HOME/Desktop -maxdepth 1 -name "Screenshot *" -exec mv {} ~/Desktop/Screen\ Shots/ \;;
    find $HOME/Desktop -maxdepth 1 -name "Screen\ Recording *" -exec mv {} ~/Desktop/Screen\ Shots/ \;;
}
